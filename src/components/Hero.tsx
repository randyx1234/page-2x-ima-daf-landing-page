    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 py-20 text-center text-white">
        <h1 className="mb-6 text-5xl font-bold leading-tight md:text-6xl lg:text-7xl max-w-5xl mx-auto animate-fade-in">
          Support Honest Medicine<sup className="text-lg font-normal relative -top-5 ml-0.5">™</sup> Through Your Donor-Advised Fund
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <Button size="lg" variant="outline" className="border-2 border-white bg-white text-foreground hover:bg-white/90 text-lg px-8 py-6">
